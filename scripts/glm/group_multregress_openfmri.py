...
def l1_contrasts_num(model_id, task_id, dataset_dir, nl2):
    # Oli : changed to reflect new contrast coding
    # l1l2idx looks like ['l1-01-l2-01', 'l1-01-l2-02', 'l1-02-l2-01', ...]
    import numpy as np
    import os
    contrast_def = []
    contrasts = 0
    ...
    l1_copes = range(1, contrasts + 1)
    l2_copes = range(1, nl2 + 1)

    l1l2idx = []
    for l1c in l1_copes:
        for l2c in l2_copes:
            l1l2idx.append('_l1-%02d-l2-%02d' % (l1c, l2c))
...
def group_multregress_openfmri(dataset_dir, model_id=None, task_id=None, l1output_dir=None, out_dir=None, 
    ...
    for task in task_id:
        ...
        # TODO: hard coded number of l2 copes for now.
        # could be made more flexible by reading from specification text file ('runcontrast.txt')
        nl2 = 2

        cope_ids = l1_contrasts_num(model_id, task, dataset_dir, nl2)
