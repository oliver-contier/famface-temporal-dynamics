...
"""
This script executes pre-processing, first- and second-level analysis.
Source: https://github.com/nipy/nipype/blob/master/examples/fmri_ants_openfmri.py (retrieved 5/12/2017)

Modified for our purpose by replacing built-in 'create_fixed_effects_workflow()'
with our custom 'create_run_flow()' function (imported from run_flow.py)
to model dynamic changes in second-level analysis.
"""
...
# TODO: To perform motion correction in reference to last run, this pre-built
# TODO: pipeline woulc have to be adjusted ... or a new one written.
...
def analyze_openfmri_dataset(data_dir, subject=None, model_id=None,
    ...
    mcrefvol : str
        Which volume of the FIRST RUN to use as reference for motion correction.
    """
    ...
    # TODO: set mcrefvol somewhere
    preproc = create_featreg_preproc(whichvol=mcrefvol, whichrun=refrun)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mcrefrun', default=0, dest="mcrefrun",
                        type=int, help="reference run for motion correction")
