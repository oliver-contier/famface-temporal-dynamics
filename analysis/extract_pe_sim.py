...
def extract_runs_famface_betas(base_dir, out_dir, subdir_template, sub_id, outfilename, beta_filename):
    """
...
if __name__ == '__main__':
    ...
    for stats in ['tstat', 'zstat', 'cope', 'varcope']:
        ...
        for cond in conds.keys():
            extract_runs_famface_betas(base_dir, out_dir, subdir_template, sub_id,
