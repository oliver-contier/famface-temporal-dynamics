...
if __name__ == '__main__':
    ...
    # and subject specific CSF mask (in mni)
    mnimask = join(base_dir, 'registration', subdir_template, 'warpsegment',
                      'mapflow', '_warpsegment0', 'highres001_brain_pve_0_trans.nii.gz')
